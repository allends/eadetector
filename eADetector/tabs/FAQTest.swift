...
struct FAQTest: View {
    ...
    let questions: [FAQQuestion] = [
        ...
        FAQQuestion(text: "Preparing a balanced meal", choices: ["Dependent", "Requires assistance", "Has difficulty but does by self", "Normal", "Never did but could do now", "Never did and would have difficulty now"], points: [3, 2, 1, 0, 0, 1]),
