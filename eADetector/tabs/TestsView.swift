        ...
        NavigationView {
                VStack {
                    ScrollView{
                        ...
                        Spacer()
                        CardView(content: "This quick test provides the average reaction time for a user by clicking on colored dots", name: "Reaction Time Test", date:"02/3/2020", test: "Reaction")
                        Spacer()
